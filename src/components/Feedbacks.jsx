...
const FeedbackCard = ({
  ...
  return (
    <motion.div
      ...
      className="bg-black-200 p-10 rounded-3xl xs:w-[320px] w-full mx-2 my-1"
    >
      <p className="text-white font-black text-[48px]">"</p>

      <div className="mt-1">
        <p className="text-white trackng-wider text-[18px]">{testimonial}</p>

        <div className="mt-7 flex justify-between items-center gaps-1">
